...
void start_pub_point()
{
    system("cd racecar/src/multi_goal/src;python3 get_pos_advertise.py");
}
void start_sub_point()
{
    system("cd racecar/src/multi_goal/src;python3 get_pos_sub.py");
}
...
public:
    ...
    void initialize()
    {
        ...
        // 订阅 摄像头 信息
        cam_sub = nh_.subscribe("/change", 5, &PubAndSub::CamCallback, this);
...
//     system("cd racecar/src/multi_goal/src;python3 get_pos_sub.py");
// }
// void start_gmapping() // 单独开
// {
//     system("roslaunch racecar amcl_nav.launch");
// }
...
void PubAndSub::NavCallback(const geometry_msgs::Twist& twist)
{
    ...
    //     thread th1(save_map);
    //     th1.detach();
    //     thread th2(start_nav_launch);
    //     th2.detach();
    //     thread th3(start_goal_loop);
    //     th3.detach();
    //     cnt = 1;
    // }
}
